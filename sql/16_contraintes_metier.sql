-- ============================================================================
-- CONTRAINTES MÉTIER POUR LA BASE DE DONNÉES NOVA
-- Script SQL à exécuter dans Supabase SQL Editor
-- ============================================================================

-- ============================================================================
-- 1. CONTRAINTES SUR LA TABLE USER
-- ============================================================================
...
-- Validation du numéro de téléphone (format international ou local)
-- Accepte: +237 6XX XXX XXX, 6XXXXXXXX, +221 7X XXX XX XX, etc.
ALTER TABLE "User" ADD CONSTRAINT "User_telephone_format_check" 
CHECK (telephone ~* '^\+?[0-9\s]{8,20}$');

-- Longueur minimale du mot de passe (hashé avec bcrypt = 60 caractères)
ALTER TABLE "User" ADD CONSTRAINT "User_password_length_check" 
CHECK (LENGTH(password) >= 60);

-- Nom et prénom non vides
ALTER TABLE "User" ADD CONSTRAINT "User_nom_not_empty_check" 
CHECK (LENGTH(TRIM(nom)) >= 2);

ALTER TABLE "User" ADD CONSTRAINT "User_prenom_not_empty_check" 
CHECK (LENGTH(TRIM(prenom)) >= 2);

-- ============================================================================
-- 2. CONTRAINTES SUR LA TABLE TRAJET
-- ============================================================================
...
-- ============================================================================
-- 3. CONTRAINTES SUR LA TABLE VEHICULE
-- ============================================================================
...
-- ============================================================================
-- 4. CONTRAINTES SUR LA TABLE CONDUCTEUR
-- ============================================================================
...
-- ============================================================================
-- 5. CONTRAINTES SUR LA TABLE HORAIRE
-- ============================================================================
...
-- Date de départ dans le futur ou présent (désactivé pour les données de test)
-- ALTER TABLE "Horaire" ADD CONSTRAINT "Horaire_date_futur_check" 
-- CHECK ("dateDepart" >= CURRENT_TIMESTAMP);

-- ============================================================================
-- 6. CONTRAINTES SUR LA TABLE RESERVATION
-- ============================================================================
...
-- ============================================================================
-- 7. CONTRAINTES SUR LA TABLE PAIEMENT
-- ============================================================================
...
-- ============================================================================
-- 8. CONTRAINTES SUR LA TABLE ABONNEMENT
-- ============================================================================
...
-- ============================================================================
-- 9. CONTRAINTES SUR LA TABLE REDUCTION
-- ============================================================================
...
-- ============================================================================
-- 10. CONTRAINTES SUR LA TABLE BAGAGE
-- ============================================================================
...
-- ============================================================================
-- 11. TRIGGERS POUR CONTRAINTES COMPLEXES
-- ============================================================================
...
-- ============================================================================
-- 12. INDEX POUR OPTIMISER LES VÉRIFICATIONS
-- ============================================================================
...
-- Pour voir toutes les contraintes créées:
-- SELECT conname, contype, conrelid::regclass 
-- FROM pg_constraint 
-- WHERE conrelid::regclass::text IN ('User', 'Trajet', 'Vehicule', 'Conducteur', 'Horaire', 'Reservation', 'Paiement', 'Abonnement', 'Reduction', 'Bagage');
